...
@Configuration
//@EnableWebMvc // suporta spring mvc na sua app e tambem vao subir instancia do sprinboot e tem acesso ao jackson
public class WebConfig implements WebMvcConfigurer {
	...
	public void addCorsMappings(CorsRegistry registry) {
		registry.addMapping("/**")
		.allowedMethods("GET","POST","PUT","DELETE","PATCH","OPTIONS","HEAD","TRACE","CONNECT"); // permite cross domain para todo mundo
	}
